...
public interface GoogleGeminiService extends GenerativeAiService {
    ...
    GoogleGeminiResp textOnlyImput(GoogleGeminiReq req);
    ...
    default String generateContent(String objective, String context) {
        ...
        try {
            GoogleGeminiResp resp = textOnlyImput(req);
            return resp.candidates().getFirst().content().parts().getFirst().text();
        } catch (FeignException unexpectedError) {
            return "Deu ruim! Erro de comunicação com APÌ do ";
